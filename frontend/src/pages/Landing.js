...
function Landing() {
  ...
  return (
    <div className="landing-page page-transition">
      ...
      <BrandMedia variant="hero">
        <div className="hero-container">
          <div className="hero-left">
            <span className="brand-media-badge hero-badge">CAMPUS TASK EXCHANGE</span>
            <SplitText
            ...
            <div className="hero-cta-row" style={{ marginTop: '32px' }}>
              <ArrowButton to="/browse" variant="primary" className="hero-btn-primary">Browse Tasks</ArrowButton>
      ...
      {/* TRUST SECTION */}
      <FadeContent delay={120} direction="up" distance={16}>
        <section className="trust-section" style={{ marginTop: '36px' }}>
